                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Accordion defaultActiveKey="0">
                                        <Accordion.Item eventKey="0">
                                            <Accordion.Header>
                                                Moves for {cynthiaPokemon.pokemon.name} - HP: {cynthiaTeamHP[cynthiaPokemon.pokemon.pokedex_number]} / {cynthiaPokemon.pokemon.hp}
                                            </Accordion.Header>
                                            <Accordion.Body>
                                                <ul>
                                                    {cynthiaPokemon.chosen_moves.map((move, index) => (
                                                        <li key={index}>{move.learnable_move.name}</li>
                                                    ))}
                                                </ul>
                                            </Accordion.Body>
                                        </Accordion.Item>
