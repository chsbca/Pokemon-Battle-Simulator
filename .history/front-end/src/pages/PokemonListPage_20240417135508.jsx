    ...
    return (
        <div className="container">
            ...
            <div className="pagination-controls d-flex justify-content-center">
                <button onClick={handleFirstPage} disabled={page === 1} className="btn btn-primary mx-1">First Page</button>
                <button onClick={handlePrevious} disabled={page === 1} className="btn btn-primary mx-1">Previous</button>
                <button onClick={handleNext} disabled={page >= lastPage} className="btn btn-primary mx-1">Next</button>
                <button onClick={handleLastPage} disabled={page >= lastPage} className="btn btn-primary mx-1">Last Page</button>
            </div>
            <div className="row">
