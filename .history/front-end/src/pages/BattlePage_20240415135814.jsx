                        ...
                        <Col md={6}>
                            <Card>
                                <Card.Body>
                                    ...
                                    <ProgressBar now={60} label={`HP: ${currentPokemon.pokemon.hp}`} />
                                            ...
                                            {ourTeam.map((poke, index) => (
                                                <Accordion key={index}>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        <Accordion.Body>
                                                            <Button onClick={() => selectPokemon(poke)}>Select</Button>
                                                        </Accordion.Body>
                                                    </Accordion.Item>
                                                </Accordion>
                                            ))}
                        ...
                        <Col md={6}>
                            <Card>
                                <Card.Body>
                                    ...
                                    <ProgressBar now={40} label={`HP: ${cynthiaPokemon.pokemon.hp}`} />
