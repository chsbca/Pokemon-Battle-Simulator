...
const BattlePage = () => {
    ...
    const ourMoves = ["Tackle", "Growl", "Vine Whip", "Razor Leaf"]; // Example moves
        ...
        <Container className="mt-5 text-center">
            ...
            <Row className="justify-content-between align-items-center">
                <Col md={4}>
                    ...
                    <div className="d-grid gap-2 d-md-flex justify-content-md-around mt-3">
                        {ourMoves.map((move, index) => (
                            <Button key={index} variant="outline-primary">{move}</Button>
                        ))}
                    </div>
                </Col>
                <Col md={4}>
