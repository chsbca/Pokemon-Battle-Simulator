    ...
    const getTypeEffectiveness = (moveType, defenderTypes) => {
        ...
        defenderTypes.forEach(defenderType => {
            ...
            if (typeEffect) {
                ...
                console.log(`Effectiveness for move type ${moveType} against ${defenderType.name}: ${foundEffectiveness.effectiveness} (${effectivenessMultipliers[foundEffectiveness.effectiveness]})`);
            } else {
                // Log when no specific effectiveness relation is found
                console.log(`No specific effectiveness relation found for move type ${attackerMoveType} against ${defenderType.name}`);
            }
