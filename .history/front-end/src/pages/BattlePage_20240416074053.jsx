...
const BattlePage = () => {
    ...
    useEffect(() => { //check if the player is out
        if (currentPokemon && ourTeamHP[currentPokemon.pokemon.pokedex_number] <= 0) {
        ...
        return () => clearTimeout(delayCheck); // Cleanup the timeout if the component unmounts
