    ...
    return (
        <div className="container">
            ...
            <div className="pagination-controls">
                <button onClick={handleFirstPage} disabled={page === 1} className="btn btn-primary" style={{ margin: '5px' }}>First Page</button>
                <button onClick={handlePrevious} disabled={page === 1} className="btn btn-primary" style={{ margin: '5px' }}>Previous</button>
                <button onClick={handleNext} disabled={page >= lastPage} className="btn btn-primary" style={{ margin: '5px' }}>Next</button>
                <button onClick={handleLastPage} disabled={page >= lastPage} className="btn btn-primary" style={{ margin: '5px' }}>Last Page</button>
            </div>
            <div className="row">
