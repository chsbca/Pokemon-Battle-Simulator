        ...
        <Container>
            <div className="container">
                ...
                <div style={{ textAlign: 'center' }}>
                    <img src="/pokemonlist.png" alt="Pokémon List" style={{ maxWidth: '80%', height: 'auto' }} />
                </div>
                ...
                <div className="row">
                    {pokemonDetails.map((pokemon, index) => (
                        <div key={index} className="col-sm-6 col-md-4 col-lg-3 mb-4">
                            <div className="card">
                                <img src={pokemon.sprite} className="card-img-top" alt={pokemon.name} style={{ maxWidth: '50%', height: 'auto' }} />
