...
const BattlePage = () => {
    ...
    const getTypeEffectiveness = (moveType, defenderTypes) => {
        ...
        defenderTypes.forEach(defenderType => {
            ...
            let typeEffect = moveType.move_type.effectiveness_relations.find(relation => relation.target_type === defenderTypes)
            ...
            if (typeEffect) {
                ...
                console.log(`Effectiveness for move type ${moveType.move_type} against ${defenderType.name}: ${typeEffect.effectiveness} (${effectivenessMultipliers[typeEffect.effectiveness]})`);
