...
const BattlePage = () => {
    ...
    function calculateDamage(attacker, defender, move, level = 50) {
        ...
        const attackStat = attacker.stats.attack; // Assuming 'attacker' has a stats object
        const defenseStat = defender.stats.defense; // Assuming 'defender' has a stats object
