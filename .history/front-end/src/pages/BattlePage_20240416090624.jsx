...
const BattlePage = () => {
    ...
    const performBattle = async (firstAttacker, secondAttacker, firstMove, secondMove) => { // peformBattle with AI
        // Execute the first attack
        const newHPAfterFirstAttack = executeAttack(firstAttacker, secondAttacker, firstMove);
        ...
        setTimeout(async () => {
            if (newHPAfterFirstAttack > 0) {
                ...
                if (secondAttacker === cynthiaPokemon) {
                    ...
                    // const openAIDecision = await fetchCynthiasDecision(secondAttacker);
                    // executeAttack(secondAttacker, firstAttacker, openAIDecision.move);
                ...
                // Fetch next Pokémon via OpenAI if the second attacker is Cynthia and her Pokémon fainted
                if (secondAttacker === cynthiaPokemon) {
