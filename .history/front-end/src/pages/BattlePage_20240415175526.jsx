...
const BattlePage = () => {
    ...
    const performBattle = (firstAttacker, secondAttacker, firstMove, secondMove) => {
        executeAttack(firstAttacker, secondAttacker, firstMove, () => {
            // This callback function executes after the first attack and HP update
            setTimeout(() => {
    ...
    const executeAttack = (attacker, defender, move, callback) => {
        ...
        updateHP(prevHP => ({ ...prevHP, [defender.pokemon.pokedex_number]: newHP }), () => {
            // This callback ensures that the state is updated before continuing
