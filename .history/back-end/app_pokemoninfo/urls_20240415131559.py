...
from . import views
from app_teams.views import CynthiaTeamView
...
urlpatterns = [
    ...
    path('battle/team/', TeamBattleView.as_view(), name='battle-team-detail'),
    path('battle/pokemon/<int:pokedex_number>/', PokemonBattleView.as_view(), name='battle-pokemon-detail'),
