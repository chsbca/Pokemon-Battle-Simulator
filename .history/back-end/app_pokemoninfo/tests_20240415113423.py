...
class TeamBattleSerializerTest(TestCase):
    def setUp(self):
        ...
        pokemon = Pokemon.objects.create(
            name='Squirtle', pokedex_number=1, hp=100, level=50,
            attack=50, defense=50, special_attack=50, special_defense=50, speed=50
        )
        team, created = Team.objects.get_or_create(user=user)  # Unpack the tuple
