...
urlpatterns = [
    ...
    path('team_pokemon/<int:team_pokemon_id>/learned_moves/', views.get_learned_moves, name='get-learned-moves'),
    path('team_pokemon/<int:team_pokemon_id>/moves', ChosenMovesView.as_view(), name='chosen-moves'),
