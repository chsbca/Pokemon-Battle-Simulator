...
from app_moves.serializers import MoveSerializer
...
def pokemon_moves(request, pokemon_id):
    try:
        pokemon = Pokemon.objects.get(id=pokemon_id)
...
#         return JsonResponse({'moves': moves_data}, safe=False)
#     except Pokemon.DoesNotExist:
#         return JsonResponse({'error': 'Pokemon not found'}, status=status.HTTP_404_NOT_FOUND)
