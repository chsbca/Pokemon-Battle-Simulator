...
from .views import UserTeamByEmailView, get_user_team, CynthiaTeamView, CynthiaDecisionAPI
...
urlpatterns = [
    ...
    path('cynthia_decision/', CynthiaDecisionAPI.as_view(), name='cynthia_decision'),
]
