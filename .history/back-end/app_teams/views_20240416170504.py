...
def create_prompt(battle_details):
    return f"{battle_details['attacker']} uses {battle_details['move']}! It deals {battle_details['damage']} damage and is {battle_details['effectiveness']}! React accordingly to the first sentence of this prompt! Is it hype because super effective? Is it doubtful if not effective/doesnt affect? Or is it just simple non modified damage worth normal commentary? React now!"
