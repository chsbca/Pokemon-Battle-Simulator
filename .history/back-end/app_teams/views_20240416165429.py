...
def create_prompt(battle_details):
    return f"{battle_details['attacker']} uses {battle_details['move']}! It deals {battle_details['damage']} damage! REACT TO THE POKEMON BATTLE WITH EXPLOSIVE, HYPED UP COMMENTARY! Include a pun too! But keep your commentary to like 3-4 sentences only."
