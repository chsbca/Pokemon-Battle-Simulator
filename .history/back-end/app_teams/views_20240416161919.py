...
def create_prompt(battle_details):
    return f"{battle_details['attacker']} uses {battle_details['move']}! It deals {battle_details['damage']} damage and is {battle_details['effectiveness']}! I want you to take the prompt prior and give me it back to me WORD PER WORD. But, right after, do a newline withyour explosive hyped up commentary!!! Make sure to include a pun"
