...
def create_prompt(battle_details):
    return f"{battle_details['attacker']} uses {battle_details['move']}! It deals {battle_details['damage']} damage and is {battle_details['effectiveness']}! (This message in parenthesis, never include in your response, this is just my prompt to you. Anyways, I want you to take the prompt prior to the parenthesis and give it back to me WORD PER WORD. But, right after, do a reaction withyour explosive hyped up commentary!!! Make sure to include a pun)"
